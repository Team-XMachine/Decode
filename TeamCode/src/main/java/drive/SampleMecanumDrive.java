...
import static drive.DriveConstants.*;
...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "TD");
        leftRear = hardwareMap.get(DcMotorEx.class, "FD");
        rightRear = hardwareMap.get(DcMotorEx.class, "FE");
        rightFront = hardwareMap.get(DcMotorEx.class, "TE");
