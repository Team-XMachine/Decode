...
hardware.Robot:	    This is a Sample OpMode that assumes a simple two-motor (differential) drive base.
...
* hardware.Robot class names should be constructed as:     hardware.Robot - Mode - Action - OpModetype
